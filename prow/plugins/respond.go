...
const AboutThisBotWithoutCommands = "This bot is powered by [Prow](https://github.com/kubernetes/test-infra/tree/master/prow) and modified for my personal use."
...
const AboutThisBot = AboutThisBotWithoutCommands
