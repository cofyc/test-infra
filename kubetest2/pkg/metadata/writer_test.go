	...
	var testCases = []struct {
	...
	}{
		{
			...
			expectedOutput: strings.TrimPrefix(
				`
<?xml version="1.0" encoding="UTF-8"?><testsuite name="foo" failures="0" tests="1" time="3">
    <testcase name="noop" time="1"></testcase>
		...
		},
		{
			...
			expectedOutput: strings.TrimPrefix(
				`
<?xml version="1.0" encoding="UTF-8"?><testsuite name="foo" failures="1" tests="1" time="3">
...
<?xml version="1.0" encoding="UTF-8"?><testsuite name="foo" failures="1" tests="1" time="3">
    <testcase name="always fails (junitError)" time="1">
		...
		},
		{
			...
			expectedOutput: strings.TrimPrefix(
				`
<?xml version="1.0" encoding="UTF-8"?><testsuite name="foo" failures="1" tests="3" time="7">
    <testcase name="noop" time="1"></testcase>
